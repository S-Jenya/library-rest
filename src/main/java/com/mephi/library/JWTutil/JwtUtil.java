package com.mephi.library.JWTutil;
...
public class JwtUtil {
    ...
    public String generateToken(MyUserDetails myUserDetails) {
        ...
        return createToken(claims, myUserDetails.getLogin());
    }

    private String createToken(Map<String, Object> claims, String subject) {
        //  для вставки в jwt Токен дополнительного слова. Например, логин пользователя. Используем:
        // .setSubject(subject)
